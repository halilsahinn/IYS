...
{
    public class EfLeaveTypeRepository : EfGenericBaseRepository<LeaveTypeEntity>, ILeaveTypeService
    {
        #region FIELDS
        ...
        #region CTOR
        public EfLeaveTypeRepository(IYSDbContext dbContext) : base(dbContext)
        {
