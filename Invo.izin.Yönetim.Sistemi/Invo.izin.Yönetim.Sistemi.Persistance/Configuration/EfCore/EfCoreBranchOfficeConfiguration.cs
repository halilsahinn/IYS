...
{
    public class EfCoreBranchOfficeConfiguration : IEntityTypeConfiguration<BranchOfficeEntity>
    {
        public void Configure(EntityTypeBuilder<BranchOfficeEntity> builder)
        {
            ...
            builder.Property(p => p.BranchOfficeName).HasColumnName("BranchOfficeName").HasColumnOrder(2).IsRequired().HasMaxLength(50);
            ...
            builder.ToTable(DatabaseTableConstant.BranchOfficeName, DatabaseSchemasConstant.Hr);
