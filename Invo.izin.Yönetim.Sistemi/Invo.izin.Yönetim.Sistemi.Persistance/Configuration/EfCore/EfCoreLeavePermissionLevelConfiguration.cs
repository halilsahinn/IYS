...
{
    public class EfCoreLeavePermissionLevelConfiguration : IEntityTypeConfiguration<LeavePermissionLevelEntity>
    {
        public void Configure(EntityTypeBuilder<LeavePermissionLevelEntity> builder)
        {
            ...
            builder.Property(p => p.Level).HasColumnName("Level").HasColumnOrder(2).IsRequired().HasMaxLength(20);
            ...
            builder.ToTable(DatabaseTableConstant.LeavePermissionLevel, DatabaseSchemasConstant.Hr);
