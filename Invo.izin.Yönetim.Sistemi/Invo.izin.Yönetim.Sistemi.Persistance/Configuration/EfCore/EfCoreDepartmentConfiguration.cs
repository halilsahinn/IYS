...
{
    public class EfCoreDepartmentConfiguration : IEntityTypeConfiguration<DepartmentEntity>
    {
        public void Configure(EntityTypeBuilder<DepartmentEntity> builder)
        {
            ...
            builder.Property(p => p.DepartmentName).HasColumnName("DepartmentName").HasColumnOrder(2).IsRequired().HasMaxLength(150);
            ...
            builder.ToTable(DatabaseTableConstant.Department, DatabaseSchemasConstant.Hr);
